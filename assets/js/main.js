      ...
      projects: {
        ...
        items: {
          ...
          roadguard: {
            ...
            copy: "Модулна платформа за анализ на пътния трафик. На снимката е матрицата за анотиране на сцени - слоят, в който се описват геометрията на пътя и транспортните потоци."
          },
          wealthmatrix: {
            label: "Частна поръчка",
            title: "Wealth Matrix",
